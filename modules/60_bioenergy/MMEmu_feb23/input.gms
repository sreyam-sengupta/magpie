...
scalars
  ...
  s60_bioenergy_gj_price_1st first generation bioenergy per-GJ price (USD05MER per GJ) / 25 /
  s60_bioenergy_price_2nd second generation bioenergy price (USD05MER per GJ) / 25 /
