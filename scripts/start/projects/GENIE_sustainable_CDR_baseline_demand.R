...
###############################################
identifierFlag <- "Sustainable_CDR_baseline_rev6"
cfg$title <- "Sustainable_CDR_baseline_rev6"
###############################################
...
for (mp in mpV) {
  ...
  for (be in beV) {
    ...
    cfg$gms$c60_2ndgen_biodem <- paste0("SSP2_baseline_BD00_BE", be_str, "_G0000_price_rev6")
