...
###############################################
identifierFlag <- "Sustainable_CDR_biodiversity_rev5"
cfg$title <- "Sustainable_CDR_biodiversity_rev5"
###############################################
...
# (exo is for price-driven runs only; see GENIE_sustainable_CDR_biodiversity_price.R)
...
### GHG
gV  <- c(100) #Options: 0, 10, 20, 50, 100, 200, 400, 600, 1000, 2000, 3000, 4000
...
for (mp in mpV) {
  ...
  for (be in beV) {
    ...
    cfg$gms$c60_2ndgen_biodem <- paste0("SSP2_biodiversity_BD78_BE", be_str, "_G0000_price_rev5")
